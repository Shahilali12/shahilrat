...
read -p "7138788214:AAH3l_SSUz-h17QJttj7ZeqREmAIjC3FXtE: " token
read -p "7076342781: " id
sed -i "s/const token = '7138788214:AAH3l_SSUz-h17QJttj7ZeqREmAIjC3FXtE'/const token = '$token'/g" index.js
sed -i "s/const id = '7076342781'/const id = '$id'/g" index.js
